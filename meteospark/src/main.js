...
//LEARN NAVIGATION & RENDER SECTION
...
//variables to track where the user is
let currentLearnState = 'topics' 
let activeTopicId = null

//render the main categories (Climate, Atmosphere, Stats)
...
//render the list of lessons within a category
